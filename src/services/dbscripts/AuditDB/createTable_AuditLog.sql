...
/*
INSERT INTO rt.auditlog(eventid, applicationname, featurename, category, messagecode, messages, tracelevel, loginname, auditedon ) 
SELECT 'event1','appName1','feature1', 'cat1', 'messagecode1', 'some message', 'tracevel1', 'login1', now()
